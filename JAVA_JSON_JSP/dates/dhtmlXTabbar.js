...
//alert("Calling test tab activexxxx ");
 ...
 
{
 ...
 //alert("What is the name of tab " + tab.id);
...
dhtmlXTabBar.prototype._createTab = function(text,size){
 ...
 //alert("Creating a tab " + tab.className);
 ...
 
{
 ...
 thml+='<div style="position:absolute;background-repeat: repeat-x;background-image:url('+this._imgPath+this._mode+this._styles[this._cstyle][1]+');height:'+(this._height+(this._bMode?1:3))+'px;top:0px;left:'+this._styles[this._cstyle][7]+'px;width:'+(parseInt(size||this._tabSize)-this._styles[this._cstyle][8]-this._styles[this._cstyle][7]+"px")+';"><div id=' + text + ' style="padding-top:3px;">'+text+'<div></div>';
}
 ...
 //alert("What is the value of inner html " + thml);
